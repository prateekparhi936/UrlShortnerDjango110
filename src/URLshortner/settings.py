...
SECRET_KEY = 'iqwp^!xyle6v+q(4c5^d(qmvnagn_)d-!_7lox$!3jz17n=p6l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
# 'tirr.com', 'www.tirr.com', 'www.URLshortner.co', 'URLshortner.co'
...
# ROOT_HOSTCONF = 'URLshortner.hosts'
# DEFAULT_HOST = 'www'
# DEFAULT_REDIRECT_URL = "http://127.0.0.1:8000" #kirr.co
